...
interface VisitDelegate {
    fun extractAllPrescriptions(visits: UserVisits): MutableList<PrescriptionUpdate>
    ...
    fun extractAllLabResults(visits: UserVisits): MutableList<LabResultUpdate>
    ...
    fun extractAllDiagnosis(visits: UserVisits): MutableList<DiagnosisUpdate>
